...
class UserTest(unittest.TestCase):
    @mock.patch('src.user.ApiObject.request_data')
    @mock.patch('src.user.ApiObject.__init__')
    ...
    def test_user_get(self, mock_api_object_init, mock_api_object_request_data):
        ...
        mock_api_object_request_data.assert_called_once_with('/v3/users/test_user/businesses/')
