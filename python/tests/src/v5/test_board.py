...
class BoardTest(unittest.TestCase):
    ...
    @mock.patch('src.v5.board.ApiObject.__init__')
    def test_board_actions(self, mock_api_object_init, mock_api_object_post_data,
                           mock_api_object_get_iterator, mock_api_object_delete):
        ...
        # test text_id
        test_text_id = Board.text_id({'owner': {'username':'test_board_username'},
                                      'name': 'Test Board Name'})
