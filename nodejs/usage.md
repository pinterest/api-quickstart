...
## copy_pin.js
```
usage: copy_pin.js [-h] -p PIN_ID -b BOARD_ID [-s SECTION] [-a ACCESS_TOKEN] [-l LOG_LEVEL] [-v API_VERSION]
...
## delete_board.js
```
usage: delete_board.js [-h] [-b BOARD_ID] [--all-boards] [-a ACCESS_TOKEN] [-l LOG_LEVEL] [-v API_VERSION]

Delete on Board or all Boards
